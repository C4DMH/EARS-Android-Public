 ...
 * Uploads the text file of music listening to AWS
 */
...
public class MusicUploadReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        for(File each : files){
            ...
            Encrypt("Music" + formattedDate + "_" + i, each.getAbsolutePath());
            //Encrypt(each.getName(), each.getAbsolutePath()); // This was overwriting files of the same name
