...
public class ActivityUploadReceiver extends BroadcastReceiver {

    private static final String TAG = "ActivtyUploadReceiver";
    ...
    static String folder = "/MotionActivity/";
    ...
    public String Encrypt(String name, String path){
        ...
        try {
            ...
            path2 = mEncryption.encrypt(mFileName, mFilePath, "/MotionActivity/");
